...
function () {
  ...
  Slider.prototype.showSlide = function () {
    var el = this.slide[this.current].firstChild;
  ...
  Slider.prototype.doMeltForward = function () {
    this.slide[this.current].classList.add('melt-current'); // tslint:disable-next-line:max-line-length
  ...
  Slider.prototype.doSlideshowForward = function () {
    this.slide[this.current].classList.add('slideshow-current', 'slide-in-from-right'); // tslint:disable-next-line:max-line-length
  ...
  Slider.prototype.doSlideshowBackward = function () {
    this.slide[this.current].classList.add('slideshow-current', 'slide-in-from-left'); // tslint:disable-next-line:max-line-length
